...
<div><span style="font-size:11px;color:#9ca3af;font-weight:500;">2026.08</span>&nbsp;<span style="background:#dbeafe;color:#1e40af;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:600;">📄 Paper</span></div>
<div style="margin-top:3px;font-size:13px;color:#374151;">Our paper "<a href="https://arxiv.org/abs/2603.19423"><strong>The Autonomy Tax: Defense Training Breaks LLM Agents</strong></a>" is accepted to the <strong>EMNLP 2026 Main Conference</strong>.</div>
</div>

<div style="position:relative;margin-bottom:14px;">
<div style="position:absolute;left:-22px;top:4px;width:10px;height:10px;border-radius:50%;background:#3b82f6;border:2px solid white;box-shadow:0 0 0 2px #3b82f6;"></div>
<div><span style="font-size:11px;color:#9ca3af;font-weight:500;">2026.07</span>&nbsp;<span style="background:#dbeafe;color:#1e40af;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:600;">📄 Paper</span></div>
<div style="margin-top:3px;font-size:13px;color:#374151;">Our new paper "<a href="https://arxiv.org/abs/2607.27670"><strong>JigShape: Evaluating Visual-Geometric Reasoning in VLMs through Jigsaw Puzzles</strong></a>" is now on arXiv.</div>
</div>

<div style="position:relative;margin-bottom:14px;">
<div style="position:absolute;left:-22px;top:4px;width:10px;height:10px;border-radius:50%;background:#3b82f6;border:2px solid white;box-shadow:0 0 0 2px #3b82f6;"></div>
<div><span style="font-size:11px;color:#9ca3af;font-weight:500;">2026.06</span>&nbsp;<span style="background:#dbeafe;color:#1e40af;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:600;">📄 Paper</span></div>
<div style="margin-top:3px;font-size:13px;color:#374151;">Our new vision paper "<a href="https://arxiv.org/abs/2606.28739"><strong>Agent Safety Is Action Alignment</strong></a>" is now on arXiv.</div>
</div>
...
<table style="MARGIN-BOTTOM: 10px; FONT-SIZE: 13px; BORDER-COLLAPSE: collapse; TEXT-ALIGN: left; WIDTH: 98%; BACKGROUND-COLOR: #f6fbfe">
  <tbody>
  <tr>
    <td class="left" style="FONT-SIZE: 10px; TEXT-ALIGN: center; WIDTH: 60px; BACKGROUND-COLOR: #e2eff9"><a href="https://arxiv.org/pdf/2607.27670" target="_blank"><img src="./images/pdf.png" width="100" height="100"></a></td>
    <td><span class="title" style="FONT-WEIGHT: bold">JigShape: Evaluating Visual-Geometric Reasoning in VLMs through Jigsaw Puzzles</span>
      <br><b>Li Li</b>, Wei Yang, Jike Zhong, Jiate Li, Jiawei Yang, You Qin, Ryan Rossi, Franck Dernoncourt, Roger Zimmermann, Yue Wang, Zhengzhong Tu, Vicente Ordonez, Mohit Bansal, Yue Zhao
...
<table style="MARGIN-BOTTOM: 10px; FONT-SIZE: 13px; BORDER-COLLAPSE: collapse; TEXT-ALIGN: left; WIDTH: 98%; BACKGROUND-COLOR: #f6fbfe">
  <tbody>
  <tr>
    <td class="left" style="FONT-SIZE: 10px; TEXT-ALIGN: center; WIDTH: 60px; BACKGROUND-COLOR: #e2eff9"><a href="https://arxiv.org/pdf/2606.28739" target="_blank"><img src="./images/pdf.png" width="100" height="100"></a></td>
    <td><span class="title" style="FONT-WEIGHT: bold">Agent Safety Is Action Alignment</span>
...
<table style="MARGIN-BOTTOM: 10px; FONT-SIZE: 13px; BORDER-COLLAPSE: collapse; TEXT-ALIGN: left; WIDTH: 98%; BACKGROUND-COLOR: #f6fbfe">
  <tbody>
  <tr>
    <td class="left" style="FONT-SIZE: 10px; TEXT-ALIGN: center; WIDTH: 60px; BACKGROUND-COLOR: #e2eff9"><a href="https://arxiv.org/pdf/2605.09163" target="_blank"><img src="./images/pdf.png" width="100" height="100"></a></td>
    <td><span class="title" style="FONT-WEIGHT: bold">FORTIS: Benchmarking Over-Privilege in Agent Skills</span>
      <br><b>Li Li</b>, Chenxiao Yu, Han Wang, Wei Yang, Ryan Rossi, Franck Dernoncourt, Xiyang Hu, Philip Yu, Chaowei Xiao, Huan Zhang, Yue Zhao
    <br><span style="background:#f3f4f6;color:#4b5563;padding:2px 7px;border-radius:4px;font-size:11px;font-weight:600;">Preprint</span>&nbsp;&nbsp;
  </td>
  </tr>
 </tbody>
